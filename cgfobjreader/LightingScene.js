...
class LightingScene extends CGFscene
{
	init(application)
	{
		...
		this.suzanne = new CGFOBJModel(this, 'models/BMWX54.obj');
		this.male = new CGFOBJModel(this, 'models/IronMan.obj');
		this.navigator = new CGFOBJModel(this, 'models/navigator.obj', true);
		
		// Materials
        var texture = new CGFtexture(this, "models/texture.jpg");
		this.materialDefault = new CGFappearance(this);

		this.enableTextures(true);
		this.materialDefault.setTexture(texture);
